try:
    ...
    class ExecVars:
        ...
        API_HASH = "8ec7201245d6cfbb5a0394ea526120d7"
        API_ID = 7903452
        BOT_TOKEN = "1976343870:AAHm0DsV9q74tDgaf6KEV7U0vHwbgp7TFjs"
        BASE_URL_OF_BOT = "http://34.125.108.113"

        # Edit the server port if you want to keep it default though.
        SERVPORT = 80

        # ALLOWED USERS [ids of user or supergroup] seperate by commas
        ALD_USR = [-1001435862443]
        OWNER_ID = 1660185071
